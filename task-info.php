...
if(isset($_GET['delete_task'])){
  $action_id = $_GET['Reserviour_id'];
  
  $sql = "DELETE FROM task_info WHERE Reserviour_id = :id";
    ...
    <div class="modal-dialog add-category-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center">Add New Location</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" placeholder="Location" id="task_title" name="task_title" list="expense" class="form-control" id="default" required>
                    </div>
                  </div>
                  <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-warning btn-menu" data-toggle="modal" data-target="#myModal">Add New Location</button>
                </div>
              <?php } ?>
          ...
          <center ><h3>Water Supply Time</h3></center>
          <div class="gap"></div>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                 ...
                 <td><a title="Update Task"  href="edit-task.php?Reserviour_id=<?php echo $row['Reserviour_id'];?>"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                  <a title="View" href="task-details.php?Reserviour_id=<?php echo $row['Reserviour_id']; ?>"><span class="glyphicon glyphicon-folder-open"></span></a>&nbsp;&nbsp;
                  <?php if($user_role == 1){ ?>
                  <a title="Delete" href="?delete_task=delete_task&Reserviour_id=<?php echo $row['Reserviour_id']; ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash"></span></a></td>
                <?php } ?>
                </tr>
                <?php } ?>
